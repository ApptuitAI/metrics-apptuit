...
public class DataPointTest {
  ...
  public void testToTextWithGlobalTags() throws Exception {
    ...
    ByteArrayOutputStream out = new ByteArrayOutputStream();
    dataPoint.toTextLine(out, tagEncodedMetricName.getTags(), Sanitizer.NO_OP_SANITIZER);
  ...
  public void testToJsonWithGlobalTags() throws Exception {
    ...
    ByteArrayOutputStream out = new ByteArrayOutputStream();
    dataPoint.toJson(new PrintStream(out), tagEncodedMetricName.getTags(), Sanitizer.NO_OP_SANITIZER);
    String jsonTxt = out.toString();
  ...
  public void testToPromSanitization() throws Exception {
    ...
    dataPoint1.toTextLine(out1, tagEncodedMetricName.getTags(), Sanitizer.PROMETHEUS_SANITIZER);
    ...
    dataPoint2.toTextLine(out2, tagEncodedMetricName.getTags(), Sanitizer.PROMETHEUS_SANITIZER);
  ...
  public void testToApptuitSanitization() throws Exception {
    ...
    ByteArrayOutputStream out1 = new ByteArrayOutputStream();
    dataPoint1.toTextLine(out1, tagEncodedMetricName.getTags(), Sanitizer.APPTUIT_SANITIZER);
    ...
    ByteArrayOutputStream out2 = new ByteArrayOutputStream();
    dataPoint2.toTextLine(out2, tagEncodedMetricName.getTags(), Sanitizer.APPTUIT_SANITIZER);
  ...
  public void testToNoOpSanitization() throws Exception {
    ...
    ByteArrayOutputStream out1 = new ByteArrayOutputStream();
    dataPoint1.toTextLine(out1, tagEncodedMetricName.getTags(), Sanitizer.NO_OP_SANITIZER);
    ...
    ByteArrayOutputStream out2 = new ByteArrayOutputStream();
    dataPoint2.toTextLine(out2, tagEncodedMetricName.getTags(), Sanitizer.NO_OP_SANITIZER);
